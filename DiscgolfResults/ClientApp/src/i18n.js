...
const resources = {
  en: {
    translation: {       
      ...
      "common_filter_course": "Search course",
      "common_course_layout": "Layout",
      ...
      "courses_description": "Click on course in table to see more information",
      "course_card_numberofevents": "# events",
      "course_card_avgnumplayers": "Average # players",
      "course_card_numberofplayedrounds": "# played events",
      "course_card_holeinone": "# hole in one",
      "course_card_uniquenumplayers": "# unique players",
      ...
      "player_details_scoretrend": "Average score trend rounds",      
      "player_details_events": "Played rounds",
      "player_details_holeavg": "Hole averages",
      "player_details_scoredistibution": "Score distribution rounds",
      "player_details_holescoredistribution": "Score distribution per hole",
      ...
      "player_card_holeinone": "Number of hole in one",
      ...
      "hole_stats_relativescore_-2": "eagles",
      "hole_stats_relativescore_-1": "birdies",
      "hole_stats_relativescore_0": "pars",
      "hole_stats_relativescore_1": "bogeys",
      "hole_stats_relativescore_2": "double bogeys",
      "hole_stats_relativescore_3": "tripple bogeys or more",
      "hole_stats_hole": "Hole",
  ...
  sv: {
    translation: { 
      ...
      "courses_header": "Banor",
      "courses_description": "Klicka på bana i tabellen för att få mer information.",
      "course_card_numberofevents": "# rundor",
      "course_card_avgnumplayers": "Snitt # spelare",
      "course_card_numberofplayedrounds": "# spelade rundor",
      "course_card_holeinone": "# hole in one",
      "course_card_uniquenumplayers": "# unika spelare",
      "players_header": "Spelare",
      ...
      "player_details_scoretrend": "Snittresultat trend rundor",
      "player_details_events": "Spelade rundor",
      "player_details_holeavg": "Snittresultat per hål",
      "player_details_scoredistibution": "Resultat distribution rundor",
      "player_details_holescoredistribution": "Resultat distribution per hål",
      ...
      "player_card_holeinone": "Antal hole in one",
